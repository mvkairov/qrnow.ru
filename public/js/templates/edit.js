...
<div class="card border-light product" style="background-color: #fff;" data-product="{{ id }}">
    <div>
        ...
        <div class="menu-actions">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.75em" height="1.75em" fill="currentColor" class="bi bi-eye productAvailable" viewBox="0 0 16 16"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="1.75em" height="1.75em" fill="currentColor" class="bi bi-eye-slash productUnavailable" viewBox="0 0 16 16"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="1.75em" height="1.75em" fill="currentColor" class="bi bi-pencil-square updateProductBtn" viewBox="0 0 16 16"
...
<div style="margin: 20px auto; border-radius: 20px; border-color: #fff; padding: 0;" 
    ...
    <div class="card-header sectionImg" 
        ...
        <div class="menu-actions">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.75em" height="1.75em" fill="currentColor" class="bi bi-plus-circle addProductBtn" viewBox="0 0 16 16"
                 data-toggle="modal" data-target="#addProductCard">
                <title>Добавить блюдо</title>
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" width="1.775em" height="1.775em" fill="currentColor" class="bi bi-eye sectionAvailable" viewBox="0 0 16 16"
                 style="display: {{# if available }} none {{ else }} inline {{/ if }};">
                <title>Вернуть в меню</title>
                <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z"/>
                <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" width="1.775em" height="1.775em" fill="currentColor" class="bi bi-eye-slash sectionUnavailable" viewBox="0 0 16 16"
                 style="display: {{# if available }} inline {{ else }} none {{/ if }};">
                <title>Убрать из меню</title>
                <path d="M13.359 11.238C15.06 9.72 16 8 16 8s-3-5.5-8-5.5a7.028 7.028 0 0 0-2.79.588l.77.771A5.944 5.944 0 0 1 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.134 13.134 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755-.165.165-.337.328-.517.486l.708.709z"/>
                <path d="M11.297 9.176a3.5 3.5 0 0 0-4.474-4.474l.823.823a2.5 2.5 0 0 1 2.829 2.829l.822.822zm-2.943 1.299l.822.822a3.5 3.5 0 0 1-4.474-4.474l.823.823a2.5 2.5 0 0 0 2.829 2.829z"/>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="1.775em" height="1.775em" fill="currentColor" class="bi bi-pencil-square updateSectionBtn" viewBox="0 0 16 16"
                 data-toggle="modal" data-target="#addSectionCard">
                <title>Изменить раздел</title>
                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" width="1.775em" height="1.775em" fill="currentColor" class="bi bi-trash deleteSectionBtn" viewBox="0 0 16 16"
            ...
            <div class="container-fluid padding">
                <div class="row padding">
                    ...
                    <div class="col-12 text-center">
                        <button type="button" class="btn btn-secondary btn-block btn-sm addProductBtn"
                                data-toggle="modal" data-target="#addProductCard">
