		...
		<div class="container">
			<div class="header_inner">
				...
				<nav class="nav" id="cartButton">
                    <li style="display:block; position: relative; float: left;">
                        <a style="display: block;" data-toggle="modal" data-target="@if(isset($order)) #cartModal @endif" class="nav_link" id="cartLink"><svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-basket" fill="@if(isset($order))#currentColor @else #666 @endif" id="cartSVG" style="transition: 0.3s ease;" xmlns="http://www.w3.org/2000/svg">
